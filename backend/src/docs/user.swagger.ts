 ...
 *                       example: "Mateus Silva"
 *       401:
 *         description: Email ou senha incorretos / usuário não encontrado
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Nenhuma sessão ativa"
 *       500:
 *         description: Erro ao destruir sessão
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Erro interno ao buscar usuário"
 */
export {}
