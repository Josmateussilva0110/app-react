...
import { KeyRound, Lock, LogOut } from "lucide-react-native";
...
export function ChangePasswordRequiredScreen() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sem esta saída, quem entrou na conta errada fica preso na tela: o
            portão de (protected) só libera depois da troca de senha. */}
        <TouchableOpacity
          style={styles.logout}
          onPress={() => void logout()}
          disabled={busy}
