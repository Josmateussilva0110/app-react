-- Revoga acesso direto à RPC get_product_stats via PostgREST (IDOR).
-- Backend continua usando service_role.
...
REVOKE ALL ON FUNCTION public.get_product_stats(integer, integer, uuid, uuid, uuid, text, boolean) FROM authenticated;
